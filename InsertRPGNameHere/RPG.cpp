...
void Player::Choice()
{
	...
	while (true)
	{
		...
		else if (convert.ToUpper(playerChoice) == "INSPECT")
		{
			...
			speak.TypewriterPrintENDL(speak.FG_BRIGHT_CYAN + nametag + locations.rooms[currentRoom].inspect + speak.RESET, 15);
...
Player::Player()
{
	...
	speak.TypewriterPrint(speak.FG_BRIGHT_YELLOW + "Enter your name: " + speak.RESET, 20);
	...
	cout << speak.FG_BRIGHT_YELLOW +  "go east" + speak.RESET << endl;
	cout << speak.FG_BRIGHT_YELLOW +  "go west" + speak.RESET << endl;
	cout << speak.FG_BRIGHT_YELLOW +  "inspect" + speak.RESET << endl;
